				       ...
				       const struct counter_top_cfg *cfg)
{
	...
	error_code = sl_sleeptimer_start_periodic_timer(&top_timer,
							cfg->ticks,
							top_callback,
				   ...
				   const struct counter_alarm_cfg *alarm_cfg)
{
	...
	error_code = sl_sleeptimer_is_timer_running(&alarm_timer[chan_id],
						    &is_alarm_timer_running);
	...
	error_code = sl_sleeptimer_start_timer(&alarm_timer[chan_id],
					       dev_data->alarm[chan_id].ticks,
					       alarm_callback,
